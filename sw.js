const CACHE='alziyad-calendar-v3';
const CORE=['./','./index.html','./manifest.webmanifest','./logo.jpg','./icon-192.png','./icon-512.png','./assets/work-interior.jpg','./assets/work-garden.jpg','./assets/work-hall.jpg','./assets/work-exterior-night.jpg','./assets/work-lighting.jpg','./assets/work-villa.jpg'];
