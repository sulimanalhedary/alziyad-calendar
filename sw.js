const CACHE='alziyad-calendar-v12';
const CORE=['./additional-photos.js','./calendar-content.js','./user-photos.js','./photo-engine.js','./photo-catalog.js','./','./index.html','./manifest.webmanifest','./logo.jpg','./icon-192.png','./icon-512.png','./riyadh-city.jpg','./riyadh-work.jpg'];
