const CACHE='alziyad-calendar-v5';
const CORE=['./','./index.html','./manifest.webmanifest','./logo.jpg','./icon-192.png','./icon-512.png','./assets/riyadh-city.jpg','./assets/riyadh-work.jpg'];
